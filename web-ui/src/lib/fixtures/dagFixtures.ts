...
const FEATURE_DEVELOPMENT: FixtureSnapshot = {
  ...
  edges: [
    ...
    { source_node_id: "code_review",  target_node_id: "review_escalation", condition: "need_human_decision:review_conflict" },
    { source_node_id: "code_review",  target_node_id: "review_escalation", condition: "need_human_decision:uncertainty" },
    { source_node_id: "review_escalation", target_node_id: "test",        condition: "approved" },
