...
/**
 * Request body for the validated-transition Task status write:
 ...
 * note, recorded on the audit trail but not persisted as a column (no migration,
 * per the "computed, not persisted" precedent).
 */
