 ...
 * "task_changed"}/{@code "run_status_changed"}/{@code "dependency_changed"} (added for the
 * Roadmap Graph View's dependency-edge support). For {@code "dependency_changed"}, {@code itemId}
