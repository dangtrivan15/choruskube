 ...
 * totalRunCount} stay empty/zero everywhere except the Roadmap Graph View — embedding
 * run history is specific to that view, unrelated to the list-readiness change.
 ...
 *
 * <p>{@code priority} (the roadmap dependencies/priorities/milestones feature)
